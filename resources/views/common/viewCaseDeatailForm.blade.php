                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <select class="form-control" id="area" disabled>
                                                @foreach ($lbo_district as $item)
                                                    <option id="area-{{ $item->id }}" value="{{ $item->id }}">{{ $item->label_tc }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            {{--<input type="company_id" readonly id="company_id" name="company_id" class="form-control" value="">--}}
                                            <select class="form-control" id="company" name="company">
                                                @foreach ($companys as $item)
                                                    <option id="company-{{ $item->company_id }}" value="{{ $item->company_id }}">{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            ...
                                            <select class="form-control" id="job_status" disabled>
                                                ...
                                                @foreach ($lbo_employment as $item)
                                                    <option id="job_status-{{ $item->id }}" value="{{ $item->id }}">{{ $item->label_tc }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col">
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <select class="form-control" id="lbo_loan_purpose">
                                            ...
                                            @foreach ($lbo_loan_purpose as $item)
                                                <option changeable id="purpose-{{$item->id}}" value="{{ $item->id }}">{{ $item->label_tc }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
