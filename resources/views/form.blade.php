...
<head>
    ...
    <link rel="stylesheet" href="{{ config('app.assets_path') }}/assets/bootstrap-4.6.1-dist/css/bootstrap.min.css">

    {{-- TimePickerStyle --}}
    <!-- Daterange picker -->
    <link
        href="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/bootstrap-daterangepicker/daterangepicker.css"
        rel="stylesheet">
    <!-- Clockpicker -->
    <link
        href="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/clockpicker/css/bootstrap-clockpicker.min.css"
        rel="stylesheet">
    <!-- asColorpicker -->
    <link
        href="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/jquery-asColorPicker/css/asColorPicker.min.css"
        rel="stylesheet">
    <!-- Material color picker -->
    <link
        href="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css"
        rel="stylesheet">
    <!-- Pick date -->
    <link rel="stylesheet"
        href="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/pickadate/themes/default.css">
    <link rel="stylesheet"
        href="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/pickadate/themes/default.date.css">
    <!-- animati.css -->
    <link rel="stylesheet" href="{{ config('app.assets_path') }}/assets/animate.css/animate.css">


    
</head>
<script src="{{ config('app.assets_path') }}/assets/js/jQuery3.6.0.js"></script>
<script src="{{ config('app.assets_path') }}/assets/bootstrap-4.6.1-dist/js/bootstrap.bundle.min.js"></script>
...
<body>
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select id="lbo_appellation" name="lbo_appellation" class="form-control" validate>
                                    ...
                                    @foreach ($lbo_appellation as $k => $v)
                                        <option class="lbo_appellation{{ $v->id }}"
                                            value="{{ $v->id }}">
                                            {{ $v->label_tc }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <select id="lbo_district" name="lbo_district" class="form-control" validate>
                                    ...
                                    @foreach ($lbo_district as $k => $v)
                                        <option class="lbo_district{{ $v->id }}" value="{{ $v->id }}">
                                            {{ $v->label_tc }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col">
                                ...
                                <select id="lbo_employment" name="lbo_employment" class="form-control" validate>
                                    ...
                                    @foreach ($lbo_employment as $k => $v)
                                        <option class="lbo_employment{{ $v->id }}"
                                            value="{{ $v->id }}">
                                            {{ $v->label_tc }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            ...
                            <div class="col">
                                ...
                                <input type="tel" id="repayment_period" name="repayment_period" class="form-control" validate>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-row">
                            ...
                            <select id="lbo_loan_purpose" name="lbo_loan_purpose" class="form-control" validate>
                                ...
                                @foreach ($lbo_loan_purpose as $k => $v)
                                    <option class="lbo_loan_purpose{{ $v->id }}" value="{{ $v->id }}">
                                        {{ $v->label_tc }}</option>
                                @endforeach
                            </select>
                        </div>
    ...
    <script type="module">
        import FormValidate from "{{ config('app.assets_path') }}/assets/js/module/FormValidate.js";
    ...
    <!-- momment js is must -->
    <script
        src="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/moment/moment.min.js">
    </script>
    <script
        src="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/bootstrap-daterangepicker/daterangepicker.js">
    </script>
    <!-- clockpicker -->
    <script
        src="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/clockpicker/js/bootstrap-clockpicker.min.js">
    </script>
    <!-- asColorPicker -->
    <script
        src="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/jquery-asColor/jquery-asColor.min.js">
    </script>
    <script
        src="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/jquery-asGradient/jquery-asGradient.min.js">
    </script>
    <script
        src="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/jquery-asColorPicker/js/jquery-asColorPicker.min.js">
    </script>
    <!-- Material color picker -->
    <script
        src="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js">
    </script>
    <!-- pickdate -->
    <script
        src="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/pickadate/picker.js">
    </script>
    <script
        src="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/pickadate/picker.time.js">
    </script>
    <script
        src="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/vendor/pickadate/picker.date.js">
    </script>


    <!-- Daterangepicker -->
    <script
        src="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/js/plugins-init/bs-daterange-picker-init.js">
    </script>
    <!-- Clockpicker init -->
    <script
        src="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/js/plugins-init/clock-picker-init.js">
    </script>
    <!-- asColorPicker init -->
    <script
        src="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/js/plugins-init/jquery-asColorPicker.init.js">
    </script>
    ...
    <!-- Pickdate -->
    <script
        src="{{ config('app.assets_path') }}/assets/focus-premium/themes/focus-premium/focus/js/plugins-init/pickadate-init.js">
    </script>
