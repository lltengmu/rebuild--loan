...
@section('content')
    <div class="content-body">
            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4>歡迎回來！</h4>
                        <span class="ml-1">{{ $user->last_name }}{{ $user->first_name }}</span>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <form action="{{ url('clients/Clientcaseimport') }}" 
                                    name='iframeForm' 
                                    target="_self"
                                    method="POST" 
        ...
        <div id="IsImport" @if (count($errors)) vid='{{ $errors->first() }}' @endif() style="display: none">
            123123</div>
    ...
    <script>
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        $('#getfile').append(
                            ...
                            '" class="row"><a class="col-md-10" href="{{ config('app.assets_path') }}/' +
        ...
        function EditCase() {
            ...
            var obj = {
                type: 'PUT',
                url: "{{ url('Clients/Client_Case') }}/" + id,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content'),
                },
                data: {
