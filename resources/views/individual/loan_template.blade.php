                        ...
                        <form action="{{ route('image.upload.post') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="card-body">
                                <div class="basic-form" style="text-align: center">
                                    <input type="text" name="id" value="{{ $imagesrc[0]->id }}" style="display: none">
                                    <div class="form-group">
                                        <img id="uploadPreview"
                                            src="{{ config('app.assets_path') }}{{ $imagesrc[0]->template_photo }}"
                                    ...
                                    <div class="basic-form">
                                        <div class="form-group">
                                            <textarea name="template_text" class="form-control" rows="4"
                                                id="comment">{{ $imagesrc[0]->template_text }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
