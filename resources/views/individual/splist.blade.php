                        ...
                        <div class="form-group">
                            ...
                            <select id="company_id" name="company_id" class="form-control">
                                ...
                                @foreach ($splist as $k => $v)
                                    <option id="splist{{ $v->company_id }}" value="{{ $v->company_id }}">
                                        {{ $v->name }}</option>
                                @endforeach
                            </select>
                        </div>
    ...
    <script>
        ...
        function Editindividual() {
            ...
            if (
                ...
                $.ajax({
                    type: 'PUT',
                    url: "{{ url('individual/spcreate') }}/" + id,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content'),
                    },
                    data: {
        ...
        $('#deleOnclick').click(function() {
            ...
            $.post("{{ url('individual/spdelete') }}/" + id, {
                "_method": "delete",
                "_token": "{{ csrf_token() }}"
            }, function(data) {
                console.log(data);
