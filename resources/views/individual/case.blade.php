...
@section('content')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <form action="{{ url('individual/individualcaseImport') }}" method="POST"
    ...
    @include('common.viewCaseDeatailForm')
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <select id="lbo_appellation" name="lbo_appellation" class="form-control" validate>
                                                    ...
                                                    @foreach ($lbo_appellation as $k => $v)
                                                        <option class="lbo_appellation{{ $v->id }}" value="{{ $v->id }}">
                                                            {{ $v->label_tc }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-4 mb-2">
                                                ...
                                                <select id="lbo_district" name="lbo_district" class="form-control" validate>
                                                    ...
                                                    @foreach ($lbo_district as $k => $v)
                                                        <option class="lbo_district{{ $v->id }}"
                                                            value="{{ $v->id }}">
                                                            {{ $v->label_tc }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <select id="lbo_loan_purpose" name="lbo_loan_purpose" class="form-control" validate>
                                                ...
                                                @foreach ($lbo_loan_purpose as $k => $v)
                                                    <option class="lbo_loan_purpose{{ $v->id }}"
                                                        value="{{ $v->id }}">
                                                        {{ $v->label_tc }}</option>
                                                @endforeach
                                            </select>
    ...
    <script>
        ...
        function checkBoxAll() {
            $.ajax({
                type: "get",
                url: "{{ url('individual/getAllid') }}/" + undefined,
                success: function(data) {
        ...
        function SpSubmit(id) {
         ...
         document.querySelector('#EditOnclick').addEventListener('click', function(e){
            ...
            var obj = {
                type: 'POST',
                url: "{{ url('individual/editCaseLoanDetail') }}/" + document.querySelector(`input[setid]`).value,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content'),
                },
                data: data,
    ...
    <script type="module">
        ...
        document.querySelector('#selectHKID button').addEventListener('click',function(){
            ...
            $.ajax({
                type: "get",
                url: "{{ url('individual/getcase') }}/" + IsHKID,
                success: function(data) {
                    data = data[0];
                    // console.log(data);
                    if (data == undefined) {
