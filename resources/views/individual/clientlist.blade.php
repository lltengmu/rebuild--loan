...
@section('content')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container mt-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                {{-- <div id="isempty" class="alert alert-danger"
                                style="background-color: rgba(242,86,97);color: white;list-style:disc;display:none">
                                不能为空<span id="plzinput"></span>
                            </div> --}}
                                            ...
                                            <div class="col">
                                                ...
                                                <select class="form-control" id="lbo_employment">
                                                    @foreach ($lbo_employment as $k => $v)
                                                        <option class="lbo_employment{{ $v->id }}" value="{{ $v->id }}">{{ $v->label_tc }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            {{-- <div class="col">
    ...
    <script>
        ...
        function checkBox(checkbox) {
            ...
            //     return false;
            // }
            window.location.href = "{{ url('individual/clientExcel') }}/" + checkbox;
        };
        ...
        $('#deleOnclick').click(function() {
            ...
            $.post("{{ url('Individuals/client') }}/" + id, {
                "_method": "delete",
                "_token": "{{ csrf_token() }}"
            }, function(data) {
                console.log(data);
