    ...
    <script>
        let casetable = $('#casetable').DataTable({
            ...
            "ajax": {
                ...
                url: "<?php echo e(url('Sp/spapproval')); ?>",
                type: 'GET',
        ...
        function Cancel(id) {
            var obj = {
                type: 'POST',
                url: "<?php echo e(url('sp/cancel')); ?>/" + id,
                headers: {
        ...
        $('#rejectOnclick').click(function() {
            ...
            var obj = {
                type: 'GET',
                url: "<?php echo e(url('Sp/spapproval')); ?>/" + id + '/edit',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content'),
                },
                data: {
        ...
        function edit1() {
            ...
            var obj = {
                type: 'PUT',
                url: "<?php echo e(url('Sp/spapproval')); ?>/" + id,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content'),
                },
                data: {
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/fullygreatasia.admatrix-ai.com/public_html/laravel3/resources/views/sp/approval.blade.php ENDPATH**/ ?>