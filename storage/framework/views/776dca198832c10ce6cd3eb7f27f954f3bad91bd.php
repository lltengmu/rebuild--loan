            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="show_mobile" name="last_name" type="text" class="form-control" value="">
                    </div>
                    <div class="form-group">
                        <label><strong>contact</strong></label>
                        <input id="show_contact" name="last_name" type="text" class="form-control" value="">
                    </div>
                </div>
    ...
    <script>
        let mytable = $('#mytable').DataTable({
            ...
            "ajax": {
                ...
                url: "<?php echo e(url('Individuals/user')); ?>",
                type: 'GET',
        ...
        function Editindividual() {
            ...
            $.ajax({
                type: 'PUT',
                url: "<?php echo e(url('Individuals/user')); ?>/" + id,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content'),
                },
                data: {
        ...
        $('#deleOnclick').click(function() {
            ...
            $.post("<?php echo e(url('Individuals/user')); ?>/" + id, {
                "_method": "delete",
                "_token": "<?php echo e(csrf_token()); ?>"
            }, function(data) {
                console.log(data);
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\phpEnv\www\localhost\resources\views/individual/userlist.blade.php ENDPATH**/ ?>