                ...
                <div class="col-lg-6">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            ...
                            <?php endif; ?>
                            <form id="mxform" action="<?php echo e(url('clients/doLogin')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group row" style="margin-left:0 ">
                                    <input id="captcha" style="width:50%" type="text" name="captcha"
                                        class="form-control" placeholder="驗證碼">
                                    <img src="<?php echo e(url('individual/captcha')); ?>" alt="" style="float: right"
                                        onclick="this.src='<?php echo e(url('individual/captcha')); ?>?'+Math.random()" />
                                </div>
...
<?php /**PATH D:\phpEnv\www\localhost\resources\views/clients/login.blade.php ENDPATH**/ ?>