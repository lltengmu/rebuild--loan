                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4 mb-2">
                                                ...
                                                <input type="tel" id="mobile" name="mobile1" class="form-control">
                                            </div>
                                        </div>
                                    </div>
            ...
            var obj = {
                ...
                success: function(data) {
                    ...
                    if (data.status == 1) {
                        ...
                        showText();
                        sendmail(json1.email, data.id, 'individual');
                        mytable.ajax.reload();
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\phpEnv\www\localhost\resources\views/individual/clientlist.blade.php ENDPATH**/ ?>