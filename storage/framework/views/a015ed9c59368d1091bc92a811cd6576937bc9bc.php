                    ...
                    render: function(data, type, row, meta) {
                        if (type === 'display') {
                            ...
                            return '<div><button style="margin-right: 15px;" class="btn btn-rounded btn-outline-primary " onclick="CaseEdit(' +
                                row.id +
                                ');" type="button"  data-toggle="modal" data-target="#exampleModalLong">編輯</button></div>';
                        }
                        return data;
                    },
                },
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\phpEnv\www\localhost\resources\views/clients/case.blade.php ENDPATH**/ ?>